...
/**
* @brief Перечисление - Виды ошибок в запросе от клиента.
*/
...
/**
* @brief Перечисление - Виды команд от клиента.
*/
enum class CommandType {
	Unknown = 0,	// Неизвестный серверу тип команды.
	Test = 1,		// Тестовый запрос для проверки связи.
	Common = 2,		// Запрос общих данных. Типы пользователей, статусы задач.
...
/**
* @brief Перечисление - Виды запросов на получение общих (открытых) данных.
*/
enum class CommonRequest {
	Unknown = 0,	 // Неизвестный тип запроса.
	UserTypes = 1,	 // Получить список типов пользователей с описанием.
	TaskStatuses = 2 // Получить список статусов задач с описанием.
};

/**
* @brief Перечисление - Виды запросов на получение данных.
*/
enum class GetRequest {
	...
	TaskData = 5	// Получить данные конкретной задачи.
};

/**
* @brief Перечисление - Виды запросов на добавление данных.
*/
...
/**
* @brief Перечисление - Виды запросов на изменение данных.
*/
...
/**
* @brief Перечисление - Виды запросов на удаление данных.
*/
